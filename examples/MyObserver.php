 ...
 */
class MyObserver implements \Messier\Observer\IObserver
{
    ...
    */
   public function onUpdate( \Messier\Observer\IObservable $observable, $extras = null )
   {
    ...
    * @return mixed
    */
   public function onSubscribe( \Messier\Observer\IObservable $observable )
   {
      echo "- Im now subcribed to a new observable\n";
   }
    ...
    * @return mixed
    */
   public function onUnsubscribe( \Messier\Observer\IObservable $observable )
   {
...
class MyObservable extends \Messier\Observer\Observable
{
